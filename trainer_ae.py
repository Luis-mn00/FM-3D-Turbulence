...
def standard_step(model, batch, kl_weight, optimizer, config):
    ...
    return torch.tensor(0.0, device=batch.device), mse_loss, torch.tensor(0.0, device=batch.device), torch.tensor(0.0, device=batch.device)
